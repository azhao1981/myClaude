...
| 项 | 默认 | 如何覆盖 |
|---|---|---|
| Panel 成员 | glm-5.2 / minimax-m3 / mimo-v2.5-pro | 用户直接对 Claude 说"这次用 X,Y,Z" |
...
- **默认模型可达性**：mimo-v2.5-pro 已用 `omp -p --model xiaomi/mimo-v2.5-pro` 验证无头调用可行（2026-06-16）；glm-5.2 / minimax-m3 实现阶段同样逐一验证。deepseek 暂未配置，已从默认 panel 移除。
